...
export default function DonationCancelPage() {
  ...
  useEffect(() => {
    document.title = 'Donation Cancelled | RaktoDan';
    ...
    <div className="flex flex-col min-h-screen bg-gray-50 pt-24 pb-16">
      <main className="flex-grow flex items-center justify-center px-4">
        <div className="bg-white max-w-xl w-full p-8 md:p-12 rounded-2xl shadow-lg text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Donation Cancelled</h1>
          <p className="text-gray-600 text-lg mb-6">
            Your donation process has been cancelled. You can start over whenever you're ready.
          </p>

          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6">
            <Link
              to="/donate-money"
              className="inline-flex items-center justify-center bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition w-full sm:w-auto"
            >
